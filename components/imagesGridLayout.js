...
const ImagesGridLayout = () => {
  return (
    <>
      {/* <div className="w-2/5 h-[1px] bg-darkColor m-auto"></div> */}
      <div className="px-4 pt-20 pb-10">
        <Link href="/portfolio">
          <div className="grid grid-cols-gridImageTemplateColumn grid-rows-4 md:grid-cols-4 md:grid-rows-2 gap-2 cursor-pointer max-w-5xl m-auto">
            ...
            <div className="hover:brightness-105 bg-cover bg-center bg-[url('/abhinja-aromatic-oil.jpg')] h-full min-w-full col-span-2"></div>
